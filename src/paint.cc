...
void t_type_of<t_paint>::f_define(t_library* a_library)
{
	...
	(L"stroke_width__"sv, t_member<void(SkPaint::*)(float), &SkPaint::setStrokeWidth>())
	(L"stroke_miter__"sv, t_member<void(SkPaint::*)(float), &SkPaint::setStrokeMiter>())
...
{
	return t_construct_with<t_object*(*)(t_type*), t_proxy::f_new<t_paint>>::f_do(this, a_stack, a_n);
}
