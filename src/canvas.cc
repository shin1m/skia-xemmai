...
void t_type_of<xemmaix::skia::t_canvas>::f_define(t_library* a_library)
{
	...
	(L"translate"sv, t_member<void(SkCanvas::*)(float, float), &SkCanvas::translate>())
	(L"rotate"sv, t_member<void(SkCanvas::*)(float), &SkCanvas::rotate>())
	...
	(L"draw_image"sv,
		t_member<void(SkCanvas::*)(const sk_sp<SkImage>&, float, float), &SkCanvas::drawImage>(),
		t_member<void(*)(SkCanvas&, const sk_sp<SkImage>&, float, float, const SkSamplingOptions&), [](auto a_this, auto a_image, auto a_x, auto a_y, auto a_sampling)
		{
			a_this.drawImage(a_image, a_x, a_y, a_sampling);
		}>(),
		t_member<void(SkCanvas::*)(const sk_sp<SkImage>&, float, float, const SkSamplingOptions&, const SkPaint*), &SkCanvas::drawImage>()
	)
	...
	(L"draw_text"sv, t_member<void(*)(SkCanvas&, std::wstring_view, float, float, const SkFont&, const SkPaint&), [](auto a_this, auto a_text, auto a_x, auto a_y, auto a_font, auto a_paint)
	{
